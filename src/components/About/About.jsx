    ...
    <div className="about-container">
      <div className="top-section">
        ...
        <div className="skills-container">
          <div className="skills-item"><img src={html_icon} alt="skill" /><p>HTML5</p></div>
          <div className="skills-item"><img src={css_icon} alt="skill" /><p>CSS3</p></div>
          <div className="skills-item"><img src={js_icon} alt="skill" /><p>JavaScript</p></div>
          <div className="skills-item"><img src={python_icon} alt="skill" /><p>Python</p></div>
          <div className="skills-item"><img src={haskell_icon} alt="skill" /><p>Haskell</p></div>
          <div className="skills-item"><img src={intel_icon} alt="skill" /><p>Intel x86 Assembly Language</p></div>
